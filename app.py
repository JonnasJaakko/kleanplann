...
from PySide6.QtCore import Qt, Signal, QPointF, QRectF, QLineF, QTimer
...
class MainWindow(QMainWindow):
    ...
    def auto_calculate_staff(self):
        """Fill the staff field from the imported rooms without opening zones."""
