...
def test_manual_expected():
    ...
    print("\n=== РУЧНАЯ ПРОВЕРКА ===")
    ok = True
    # С прогрессивной шкалой смягчения:
    # Коридор 50 м²: 30×0.4×1.0 + 20×0.4×1.0×0.5 = 12+4 = 16 мин; ×2 = 32 мин
    # Санузел 15 м²: 15×0.4×1.8+10 = 20.8 мин; ×3 = 62.4 мин
    # Склад 100 м²: 30×0.4×0.8 + 70×0.4×0.8×0.5 = 9.6+11.2 = 20.8 мин; ×1 = 20.8 мин
    # Кухня 30 м²: 30×0.4×1.5 = 18 мин; ×2 = 36 мин
    expected = {
        "коридор": (16.0, 32.0),
        "санузел": (20.8, 62.4),  # +10 мин бонус SANITARY_BONUS_MINUTES
        "склад": (20.8, 20.8),
        "кухня": (18.0, 36.0),
    }
    for r in TEST_ROOMS:
